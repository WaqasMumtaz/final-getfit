...
class Signup extends React.Component {
    ...
    signUpFunction = async () => {
        ...
        if (name == '' || lastName == '' || email == '' || mobileNo == '' || newPasswrd == '' || cnfrmPasswrd == '' || gender == '') {
            ...
            if (nameValidate != true || emailValidate != true || mobileValidate != true || validMobile !=true || passwrdValidate != true || cnfrmPasswrdValidate != true) {
                alert('Please Enter Correct Field');
            }

        }
        else if(name != '' || lastName != '' || email != '' || mobileNo != '' || newPasswrd != '' || cnfrmPasswrd != '' || gender != ''){
            if (nameValidate != true || emailValidate != true || mobileValidate != true || validMobile !=true || passwrdValidate != true || cnfrmPasswrdValidate != true) {
                alert('Please Enter Correct Field');
            }
            else {
            ...
            try {
                ...
                if (!emailNotExist) {
                    ...
                    let userObjForProfile = {
                        ...
                        lastName:this.state.lastName,
                        contactNo: mobileNo,
                        countryCod:this.state.countryCod,
                    ...
                    if(profileCode == 200){
                        let obj = {
                            ...
                            countryCod:userProfile.content.countryCod,
        ...
        // else if (
        //     name != '' || lastName != '' || email != '' || mobileNo != '' || newPasswrd != '' || cnfrmPasswrd != '' || gender != '') {
        //         if (nameValidate == true || emailValidate == true || mobileValidate == true || validMobile == true ||
        //         passwrdValidate == true || cnfrmPasswrdValidate == true) {
    ...
    render() {
        ...
        //  console.log('Country Code >>', countryCod , 
        //  'Mobile No Valid >>',validMobile,
        //  'start >>', startNumber)
                        ...
                        <PhoneInput
                            ...
                            onChangePhoneNumber={() =>
                                this.setState({ mobileNo: this.phone.getValue(),
                                    validMobile:this.phone.isValidNumber(),
                                    countryCod:this.phone.getCountryCode(),
                                    startNumber:true
                                })
                            }
                            ...
                            style={[styles.phoneInputStyle ,
                                 validMobile == false && startNumber == true ? styles.errorInput 
                                 :null]}
